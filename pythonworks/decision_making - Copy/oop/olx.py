class Olx():
    ...
    def create(self,*args,**kwargs):
        ...
        print("vehicles added scussesfully")
        return kwargs
...
obj=Olx()
# print(obj.get())#print il kodukkune return chyyunnod

# print(obj.create(id=7,name="nano",year="2008",selling_price=88000,color="yellow",location="tvm"))
# print(obj.get())

# print(obj.retreive(id=2))
